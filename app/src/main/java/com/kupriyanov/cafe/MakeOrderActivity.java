...
public class MakeOrderActivity extends AppCompatActivity {
    ...
    private void onUserChoseTea() {
        ...
        String additivesLabel = getString(R.string.need_additives, drink);
    ...
    private void setupUserName() {
        ...
        String makeOrderAnswer = getString(R.string.makeOrderGreeting, userName);
        textViewAnswer.setText(makeOrderAnswer);
    }
